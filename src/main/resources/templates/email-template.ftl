...
<body>
     <p><strong>From:</strong>pallunimbal009@gmail.com</p>
         ...
         <p>Thank you for using our online booking service.</p>
             ...
             <p>Please find attached your electronic ticket receipt. You will need to carry a printout of the e-ticket receipt along with a valid photo identification to gain entry to the airport.</p>

             <p>Kindly ensure that all documents required for your travel are in order. Incomplete or inadequate documents may lead to denied entry into the airport and/or denied boarding. Please note that Fastays will not be liable for incomplete documentation.</p>

             <p>If you selected GST during the booking flow, please log on to the website <a href="https://www.fastays.com">www.fastays.com</a> to update your GST details under the Manage Booking tab. This can be done only within 48 hours of booking creation.</p>
